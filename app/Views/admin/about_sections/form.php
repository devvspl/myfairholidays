    ...
    <div class="row">
        <div class="col-12">
            <div class="page-title-box d-sm-flex align-items-center justify-content-between">
                <h4 class="mb-sm-0"><?= isset($section) ? 'Edit' : 'Create' ?> About Section</h4>
                <div class="page-title-right">
                    <ol class="breadcrumb m-0">
                        <li class="breadcrumb-item"><a href="<?= base_url('/admin/dashboard') ?>">Dashboard</a></li>
                        <li class="breadcrumb-item"><a href="<?= base_url('/admin/about-sections') ?>">About Sections</a></li>
            ...
            <div class="card">
                <div class="card-header">
                    <div class="row align-items-center">
                        <div class="col">
                            <h4 class="card-title mb-0"><?= isset($section) ? 'Edit' : 'Create' ?> About Section</h4>
                        </div>
                        <div class="col-auto">
                            <a href="<?= base_url('/admin/about-sections') ?>" class="btn btn-secondary btn-sm">
                ...
                <div class="card-body">
                    ...
                    <form method="POST" action="<?= isset($section) ? base_url('/admin/about-sections/update/' . $section['id']) : base_url('/admin/about-sections/store') ?>" enctype="multipart/form-data">
                        <?= csrf_field() ?>
                            ...
                            <div class="col-md-6">
                                <div class="mb-3">
                                    ...
                                    <select name="section_type" class="form-select" required id="sectionType">
                                        ...
                                        <option value="mission" <?= (old('section_type') ?? $section['section_type'] ?? '') === 'mission' ? 'selected' : '' ?>>Mission Section</option>
                                        <option value="stats" <?= (old('section_type') ?? $section['section_type'] ?? '') === 'stats' ? 'selected' : '' ?>>Statistics</option>
                        ...
                        <!-- Content Field (for mission and features) -->
                        <div class="mb-3 field-group" data-types="mission,features">
                            <label class="form-label">Content</label>
                            <textarea name="content" class="form-control" rows="6"><?= esc(old('content') ?? $section['content'] ?? '') ?></textarea>
                            <small class="text-muted">HTML content is allowed</small>
                        </div>
                        ...
                        <div class="row">
                            <div class="col-md-6">
                                <div class="mb-3 field-group" data-types="mission,features">
                                    ...
                                    <div class="mb-2">
                                        ...
                                        <small class="text-muted">Upload new image (JPG, PNG, WebP - Max 5MB)</small>
                                    </div>
                                    <div class="mb-2">
                                        <label class="form-label">Or enter image path manually:</label>
                                        <input type="text" name="image_path" class="form-control" value="<?= esc(old('image_path') ?? $section['image_path'] ?? '') ?>" placeholder="e.g., assets/images/about.jpg">
                                    </div>
                                    <?php if (!empty($section['image_path'])): ?>
                                    <div class="current-image">
                                        <label class="form-label">Current Image:</label>
                                        <div class="border rounded p-2">
                                            <img src="<?= base_url($section['image_path']) ?>" alt="Current image" style="max-width: 200px; max-height: 150px;" class="img-thumbnail">
                                            <div class="mt-1">
                                                <small class="text-muted"><?= esc($section['image_path']) ?></small>
                                            </div>
                                        </div>
                                    </div>
                                    <?php endif; ?>
                            ...
                            <div class="col-md-6">
                                <div class="mb-3 field-group" data-types="hero">
                                    ...
                                    <div class="mb-2">
                                        <label class="form-label">Or enter image path manually:</label>
                                        <input type="text" name="background_image" class="form-control" value="<?= esc(old('background_image') ?? $section['background_image'] ?? '') ?>" placeholder="e.g., assets/images/hero-bg.jpg">
                                    </div>
                        ...
                        <!-- Stats Fields -->
                        <div class="row field-group" data-types="stats">
                            <div class="col-md-6">
                                <div class="mb-3">
                                    <label class="form-label">Stat Value</label>
                                    <input type="text" name="stat_value" class="form-control" value="<?= esc(old('stat_value') ?? $section['stat_value'] ?? '') ?>">
                                    <small class="text-muted">e.g., 32K, 25+, 100</small>
                                </div>
                            </div>
                            <div class="col-md-6">
                                <div class="mb-3">
                                    <label class="form-label">Stat Label</label>
                                    <input type="text" name="stat_label" class="form-control" value="<?= esc(old('stat_label') ?? $section['stat_label'] ?? '') ?>">
                                    <small class="text-muted">HTML allowed (e.g., Happy<br>Customers)</small>
                                </div>
                            </div>
                        </div>

                        <!-- Icon Field (for features) -->
                        <div class="mb-3 field-group" data-types="features">
                            <label class="form-label">Icon</label>
                            <input type="text" name="icon" class="form-control" value="<?= esc(old('icon') ?? $section['icon'] ?? '') ?>">
                            <small class="text-muted">Emoji or icon class (e.g., 🏨, fas fa-hotel)</small>
                        </div>
                        ...
                        <div class="d-flex gap-2">
                            ...
                            <a href="<?= base_url('/admin/about-sections') ?>" class="btn btn-secondary">Cancel</a>
                        </div>
                    </form>
                </div>
            </div>
