                ...
                <div class="card">
                    ...
                    <div class="card-body">
                        ...
                        <div class="mb-3">
                            ...
                            <textarea name="nearby_attractions" id="nearby_attractions" style="display: none;"><?= old('nearby_attractions') ?></textarea>
                        </div>
                        ...
                        <div class="mb-3">
                            ...
                            <textarea name="transportation_info" id="transportation_info" style="display: none;"><?= old('transportation_info') ?></textarea>
                        </div>
                    </div>
                </div>
