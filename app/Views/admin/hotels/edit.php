...
<div class="container-fluid">
    ...
    <form action="<?= base_url('/admin/hotels/update/' . $hotel['id']) ?>" method="POST" enctype="multipart/form-data">
        <?= csrf_field() ?>
        ...
        <div class="row">
                ...
                <div class="card">
                    ...
                    <div class="card-body">
                        ...
                        <div class="mb-3">
                            ...
                            <textarea name="description" id="description" style="display: none;" required><?= old('description', $hotel['description']) ?></textarea>
                        </div>

                        <div class="mb-3">
                            <label for="short_description" class="form-label">Short Description</label>
                            <textarea class="form-control" id="short_description" name="short_description" rows="3" 
                                      placeholder="Brief summary for listings"><?= old('short_description', $hotel['short_description'] ?? '') ?></textarea>
                        </div>
                            ...
                            <div class="col-md-6">
                                <div class="mb-3">
                                    ...
                                    <input type="number" step="any" class="form-control" id="latitude" name="latitude" 
                                           value="<?= old('latitude', $hotel['latitude'] ?? '') ?>" placeholder="e.g., 40.7128">
                                </div>
                            </div>
                            <div class="col-md-6">
                                <div class="mb-3">
                                    ...
                                    <input type="number" step="any" class="form-control" id="longitude" name="longitude" 
                                           value="<?= old('longitude', $hotel['longitude'] ?? '') ?>" placeholder="e.g., -74.0060">
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="mb-3">
                            ...
                            <textarea class="form-control" id="amenities" name="amenities" rows="3" 
                                      placeholder="e.g., WiFi, Pool, Gym, Spa, Restaurant, Free Parking, Air Conditioning"><?= old('amenities', $hotel['amenities']) ?></textarea>
                            ...
                            <div class="col-md-4">
                                <div class="mb-3">
                                    ...
                                    <input type="text" class="form-control" id="contact_phone" name="contact_phone" 
                                           value="<?= old('contact_phone', $hotel['contact_phone']) ?>" placeholder="+91 9876543210">
                                </div>
                            </div>
                            <div class="col-md-4">
                                <div class="mb-3">
                                    ...
                                    <input type="email" class="form-control" id="contact_email" name="contact_email" 
                                           value="<?= old('contact_email', $hotel['contact_email']) ?>" placeholder="info@hotel.com">
                                </div>
                            </div>
                            <div class="col-md-4">
                                <div class="mb-3">
                                    ...
                                    <input type="url" class="form-control" id="website" name="website" 
                                           value="<?= old('website', $hotel['website']) ?>" placeholder="https://hotel.com">
                                </div>
                            </div>
                        </div>
                    </div>
                ...
                <div class="card">
                    ...
                    <div class="card-body">
                            ...
                            <div class="col-md-6">
                                <div class="mb-3">
                                    ...
                                    <input type="text" class="form-control" id="check_in_time" name="check_in_time" 
                                           value="<?= old('check_in_time', $hotel['check_in_time'] ?? '2:00 PM') ?>" placeholder="e.g., 2:00 PM">
                                </div>
                            </div>
                            <div class="col-md-6">
                                <div class="mb-3">
                                    ...
                                    <input type="text" class="form-control" id="check_out_time" name="check_out_time" 
                                           value="<?= old('check_out_time', $hotel['check_out_time'] ?? '12:00 PM') ?>" placeholder="e.g., 12:00 PM">
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="mb-3">
                            ...
                            <textarea name="cancellation_policy" id="cancellation_policy" style="display: none;"><?= old('cancellation_policy', $hotel['cancellation_policy'] ?? '') ?></textarea>
                        </div>

                        <div class="mb-3">
                            <label for="hotel_policies" class="form-label">Hotel Policies</label>
                            <div id="quill-hotel-policies" style="height: 250px;"></div>
                            <textarea name="hotel_policies" id="hotel_policies" style="display: none;"><?= old('hotel_policies', $hotel['hotel_policies'] ?? '') ?></textarea>
                        </div>
                    ...
                    <div class="card-body">
                        <div class="mb-3">
                            ...
                            <input type="text" class="form-control" id="meta_title" name="meta_title" 
                                   value="<?= old('meta_title', $hotel['meta_title'] ?? '') ?>" maxlength="60" 
                        ...
                        <div class="mb-3">
                            ...
                            <textarea class="form-control" id="meta_description" name="meta_description" rows="3" 
                                      maxlength="160" placeholder="Brief description for search engines"><?= old('meta_description', $hotel['meta_description'] ?? '') ?></textarea>
                        ...
                        <div class="mb-3">
                            ...
                            <textarea class="form-control" id="meta_keywords" name="meta_keywords" rows="2" 
                                      placeholder="hotel, accommodation, booking, destination name, amenities"><?= old('meta_keywords', $hotel['meta_keywords'] ?? '') ?></textarea>
                            <div class="form-text">
            ...
            <div class="col-lg-4">
                    ...
                    <div class="card-body">
                        ...
                        <div class="mb-3">
                            ...
                            <input type="number" class="form-control" id="sort_order" name="sort_order" 
                                   value="<?= old('sort_order', $hotel['sort_order'] ?? 0) ?>" min="0">
                            <div class="form-text">Lower numbers appear first</div>
                        </div>

                        <div class="form-check mb-3">
                            <input type="checkbox" class="form-check-input" id="is_featured" name="is_featured" value="1"
                                   <?= old('is_featured', $hotel['is_featured'] ?? 0) ? 'checked' : '' ?>>
                        ...
                        <div class="mb-3">
                            <small class="text-muted">
                                <strong>Slug:</strong> <?= esc($hotel['slug'] ?? 'auto-generated') ?><br>
                                <strong>Created:</strong> <?= date('M j, Y g:i A', strtotime($hotel['created_at'] ?? 'now')) ?><br>
                                <strong>Updated:</strong> <?= date('M j, Y g:i A', strtotime($hotel['updated_at'] ?? 'now')) ?>
                            </small>
                        </div>
                    </div>
                </div>
                ...
                <div class="card">
                    ...
                    <div class="card-body">
                        <?php if (isset($hotel['featured_image']) && $hotel['featured_image']): ?>
                    ...
                    <div class="card-body">
                        ...
                        <?php if (!empty($images)): ?>
                            <div class="mb-4">
                                ...
                                <div class="row g-2" id="existing_images">
                                    <?php foreach ($images as $image): ?>
                                        <div class="col-md-4 col-sm-6" data-image-id="<?= $image['id'] ?>">
                                            <div class="card">
                                                <div class="position-relative">
                                                    <img src="<?= base_url($image['image_path']) ?>" 
                                                         class="card-img-top" alt="<?= esc($image['alt_text']) ?>" 
                                                         style="height: 150px; object-fit: cover;">
                                                    <?php if ($image['is_featured']): ?>
                                                        <span class="position-absolute top-0 start-0 badge bg-warning m-1">Featured</span>
                                                    <?php endif; ?>
                                                </div>
                                                <div class="card-body p-2">
                                                    <input type="text" class="form-control form-control-sm mb-1" 
                                                           value="<?= esc($image['alt_text']) ?>" 
                                                           placeholder="Alt text" readonly>
                                                    <input type="text" class="form-control form-control-sm mb-2" 
                                                           value="<?= esc($image['caption']) ?>" 
                                                           placeholder="Caption" readonly>
                                                    <div class="btn-group w-100" role="group">
                                                        <?php if (!$image['is_featured']): ?>
                                                            <button type="button" class="btn btn-sm btn-outline-warning set-featured-btn" 
                        ...
                        <!-- Add New Images -->
                        <div class="mb-3">
                            <label for="hotel_images" class="form-label">Add New Images</label>
                    ...
                    <div class="card-body">
                        <div class="d-grid gap-2">
                            <button type="submit" class="btn btn-primary">
                                <i data-lucide="save" class="me-1"></i> Update Hotel
                            </button>
                            <a href="<?= base_url('/admin/hotels/faqs/' . $hotel['id']) ?>" class="btn btn-info">
                                <i data-lucide="help-circle" class="me-1"></i> Manage FAQs
                            </a>
...
document.addEventListener('DOMContentLoaded', function() {
    ...
    document.querySelectorAll('.delete-image-btn').forEach(btn => {
        btn.addEventListener('click', function() {
            ...
            if (confirm('Are you sure you want to delete this image?')) {
                fetch(`/admin/hotels/delete-image/${imageId}`, {
                    method: 'POST',
                    headers: {
    ...
    document.querySelectorAll('.set-featured-btn').forEach(btn => {
        btn.addEventListener('click', function() {
            ...
            fetch(`/admin/hotels/set-featured-image/${hotelId}/${imageId}`, {
                method: 'POST',
                headers: {
                    'X-Requested-With': 'XMLHttpRequest'
                }
            ...
            .then(data => {
                if (data.success) {
                    location.reload(); // Reload to update featured status
                } else {
                    showAlert('error', data.message);
                }
            })
            .catch(error => {
                showAlert('error', 'Failed to set featured image');
            });
        });
    });
    ...
    function updateKeywordCount() {
        if (!metaKeywordsInput || !keywordCountSpan) return;
