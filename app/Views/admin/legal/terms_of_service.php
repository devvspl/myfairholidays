    ...
    <div class="row">
        <div class="col-12">
            <div class="page-title-box d-sm-flex align-items-center justify-content-between">
                <h4 class="mb-sm-0">Terms of Service Management</h4>
            ...
            <div class="card">
                <div class="card-header">
                    <div class="row align-items-center">
                        <div class="col">
                            <h4 class="card-title mb-0">Edit Terms of Service</h4>
                        </div>
                        <div class="col-auto">
                            <a href="<?= base_url('/admin/terms-of-service/preview') ?>" class="btn btn-outline-primary btn-sm me-1" target="_blank">
                                <i data-lucide="eye" class="me-1"></i>Preview
                            </a>
                            <a href="<?= base_url('/terms-of-service') ?>" class="btn btn-outline-success btn-sm" target="_blank">
                ...
                <div class="card-body">
                    ...
                    <form action="<?= base_url('/admin/terms-of-service/update') ?>" method="POST" enctype="multipart/form-data">
                        <?= csrf_field() ?>
                                    ...
                                    <div class="card-body">
                                        <div class="mb-3">
                                            ...
                                            <input type="text" class="form-control" id="title" name="title" 
                                                   value="<?= old('title', $terms['title'] ?? 'Terms of Service') ?>" required>
                                        </div>
                                                ...
                                                <div class="col-md-6">
                                                    <div class="mb-3">
                                                        ...
                                                        <input type="text" class="form-control" id="banner_image" name="banner_image" 
                                                               value="<?= old('banner_image', $terms['banner_image'] ?? 'main/images/contactus.png') ?>" 
                                                               placeholder="e.g., main/images/banner.jpg">
                                                    </div>
                                                </div>
                                            </div>
                                            <?php if (!empty($terms['banner_image'])): ?>
                                            <div class="current-banner">
                                                <label class="form-label">Current Banner:</label>
                                                <div class="border rounded p-2">
                                                    <img src="<?= base_url($terms['banner_image']) ?>" alt="Current banner" style="max-width: 100%; max-height: 200px;" class="img-thumbnail">
                                                    <div class="mt-1">
                                                        <small class="text-muted"><?= esc($terms['banner_image']) ?></small>
                                                    </div>
                                                </div>
                                            </div>
                                            <?php endif; ?>
                                        ...
                                        <div class="mb-3">
                                            ...
                                            <textarea id="content" name="content" style="display:none;" required><?= old('content', $terms['content'] ?? '') ?></textarea>
                                    ...
                                    <div class="card-body">
                                        <div class="mb-3">
                                            ...
                                            <input type="text" class="form-control" id="meta_title" name="meta_title" 
                                                   value="<?= old('meta_title', $terms['meta_title'] ?? '') ?>" maxlength="255">
                                            <div class="form-text">Leave empty to use page title</div>
                                        </div>

                                        <div class="mb-3">
                                            <label for="meta_description" class="form-label">Meta Description</label>
                                            <textarea class="form-control" id="meta_description" name="meta_description" rows="3" maxlength="500"><?= old('meta_description', $terms['meta_description'] ?? '') ?></textarea>
                                        </div>

                                        <div class="mb-3">
                                            <label for="meta_keywords" class="form-label">Meta Keywords</label>
                                            <input type="text" class="form-control" id="meta_keywords" name="meta_keywords" 
                                                   value="<?= old('meta_keywords', $terms['meta_keywords'] ?? '') ?>" placeholder="keyword1, keyword2, keyword3">
                                        </div>
                                    </div>
                                </div>
                            </div>
                                    ...
                                    <div class="card-body">
                                        <div class="mb-3">
                                            ...
                                            <select class="form-select" id="status" name="status" required>
                                                <option value="active" <?= old('status', $terms['status'] ?? 'active') === 'active' ? 'selected' : '' ?>>Active</option>
                                                <option value="inactive" <?= old('status', $terms['status'] ?? '') === 'inactive' ? 'selected' : '' ?>>Inactive</option>
                                            </select>
                                        </div>
                                        ...
                                        <div class="mb-0">
                                            <small class="text-muted">
                                                ...
                                                <?= date('M d, Y h:i A', strtotime($terms['updated_at'])) ?>
                                            </small>
                                        </div>
                                        <?php endif; ?>
                                    </div>
                                ...
                                <div class="card bg-light">
                                    <div class="card-body">
                                        ...
                                        <p class="card-text small mb-0">
                                            Only one Terms of Service record is allowed. This form will update the existing record.
                                        </p>
                                    </div>
                                </div>
                                    ...
                                    <div class="card-body">
                                        <div class="d-grid gap-2">
                                            <button type="submit" class="btn btn-primary">
                                                <i data-lucide="save" class="me-1"></i> Update Terms of Service
                                            </button>
