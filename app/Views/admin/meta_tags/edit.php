        ...
        <div class="col-12">
            <div class="card">
                <div class="card-header">
                    <h4 class="card-title mb-0">Edit SEO Meta Tag</h4>
                </div>
                <div class="card-body">
                    <form action="<?= base_url('/admin/meta-tags/update/' . $metaTag['id']) ?>" method="post" id="metaTagForm">
                        <?= csrf_field() ?>
                            ...
                            <div class="col-md-8">
                                <div class="mb-3">
                                    ...
                                    <div class="input-group">
                                        ...
                                        <input type="text" class="form-control" id="page_url" name="page_url" 
                                               value="<?= old('page_url', $metaTag['page_url']) ?>" required>
                                    </div>
                                ...
                                <div class="mb-3">
                                    ...
                                    <input type="text" class="form-control" id="title" name="title" 
                                           value="<?= old('title', $metaTag['title']) ?>" required maxlength="60">
                                ...
                                <div class="mb-3">
                                    ...
                                    <textarea class="form-control" id="description" name="description" rows="3" 
                                              required maxlength="160"><?= old('description', $metaTag['description']) ?></textarea>
                                    <div class="d-flex justify-content-between">
                                ...
                                <div class="mb-3">
                                    ...
                                    <input type="text" class="form-control" id="keywords" name="keywords" 
                                           value="<?= old('keywords', $metaTag['keywords']) ?>" placeholder="travel, tourism, booking">
                                    ...
                                    <div class="col-md-6">
                                        <div class="mb-3">
                                            ...
                                            <input type="text" class="form-control" id="og_title" name="og_title" 
                                                   value="<?= old('og_title', $metaTag['og_title']) ?>" maxlength="95">
                                    ...
                                    <div class="col-md-6">
                                        <div class="mb-3">
                                            ...
                                            <select class="form-select" id="og_type" name="og_type">
                                                <option value="website" <?= old('og_type', $metaTag['og_type']) === 'website' ? 'selected' : '' ?>>Website</option>
                                                <option value="article" <?= old('og_type', $metaTag['og_type']) === 'article' ? 'selected' : '' ?>>Article</option>
                                                <option value="product" <?= old('og_type', $metaTag['og_type']) === 'product' ? 'selected' : '' ?>>Product</option>
                                                <option value="profile" <?= old('og_type', $metaTag['og_type']) === 'profile' ? 'selected' : '' ?>>Profile</option>
                                            </select>
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="mb-3">
                                    ...
                                    <textarea class="form-control" id="og_description" name="og_description" rows="2" 
                                              maxlength="300"><?= old('og_description', $metaTag['og_description']) ?></textarea>
                                ...
                                <div class="mb-3">
                                    ...
                                    <input type="url" class="form-control" id="og_image" name="og_image" 
                                           value="<?= old('og_image', $metaTag['og_image']) ?>" placeholder="https://example.com/image.jpg">
                                    ...
                                    <div class="col-md-6">
                                        <div class="mb-3">
                                            ...
                                            <select class="form-select" id="robots" name="robots">
                                                <option value="index,follow" <?= old('robots', $metaTag['robots']) === 'index,follow' ? 'selected' : '' ?>>Index, Follow</option>
                                                <option value="noindex,follow" <?= old('robots', $metaTag['robots']) === 'noindex,follow' ? 'selected' : '' ?>>No Index, Follow</option>
                                                <option value="index,nofollow" <?= old('robots', $metaTag['robots']) === 'index,nofollow' ? 'selected' : '' ?>>Index, No Follow</option>
                                                <option value="noindex,nofollow" <?= old('robots', $metaTag['robots']) === 'noindex,nofollow' ? 'selected' : '' ?>>No Index, No Follow</option>
                                            </select>
                                        </div>
                                    </div>
                                </div>
                            ...
                            <div class="col-md-4">
                                <div class="mb-3">
                                    ...
                                    <select class="form-select" id="status" name="status" required>
                                        <option value="active" <?= old('status', $metaTag['status']) === 'active' ? 'selected' : '' ?>>
                                            Active
                                        </option>
                                        <option value="inactive" <?= old('status', $metaTag['status']) === 'inactive' ? 'selected' : '' ?>>
                                            Inactive
                                        </option>
                                    </select>
                                </div>
                                ...
                                <div class="card bg-light">
                                    <div class="card-body">
                                        ...
                                        <div id="seoPreview" class="border rounded p-2 bg-white">
                                            <div id="previewTitle" class="text-primary fw-bold" style="font-size: 18px;"><?= esc($metaTag['title']) ?></div>
                                            <div id="previewUrl" class="text-success small"><?= base_url($metaTag['page_url']) ?></div>
                                            <div id="previewDescription" class="text-muted small"><?= esc($metaTag['description']) ?></div>
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="card bg-light">
                                    <div class="card-body">
                                        <h6 class="card-title">Meta Tag Information</h6>
                                        <p class="card-text small">
                                            <strong>Created:</strong> <?= date('M d, Y H:i', strtotime($metaTag['created_at'])) ?><br>
                                            <strong>Updated:</strong> <?= date('M d, Y H:i', strtotime($metaTag['updated_at'])) ?><br>
                                            <strong>ID:</strong> #<?= $metaTag['id'] ?>
                                        </p>
                                    </div>
                                </div>
                                ...
                                <div class="d-flex justify-content-between">
                                    ...
                                    <div>
                                        <button type="submit" class="btn btn-primary">
                                            <i data-lucide="save"></i> Update Meta Tag
                                        </button>
                                    </div>
                                </div>
                            </div>
