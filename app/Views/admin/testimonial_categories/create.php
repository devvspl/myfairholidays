    ...
    <div class="row">
        <div class="col-12">
            <div class="card">
                ...
                <div class="card-body">
                    <form action="<?= base_url('/admin/testimonial-categories/store') ?>" method="POST">
                        <?= csrf_field() ?>
                        ...
                        <div class="mb-3">
                            ...
                            <textarea class="form-control" id="description" name="description" 
                                      rows="4" placeholder="Brief description of this testimonial category"><?= old('description') ?></textarea>
                        </div>
