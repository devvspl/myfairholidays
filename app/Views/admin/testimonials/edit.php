        ...
        <div class="row">
                    ...
                    <div class="card-body">
                            ...
                            <div class="col-md-6">
                                <div class="mb-3">
                                    ...
                                    <input type="email" class="form-control" id="customer_email" name="customer_email" 
                                           value="<?= old('customer_email', $testimonial['customer_email'] ?? '') ?>" required>
                                </div>
                            </div>
                        </div>
                            ...
                            <div class="col-md-6">
                                <div class="mb-3">
                                    ...
                                    <input type="text" class="form-control" id="customer_city" name="customer_city" 
                                           value="<?= old('customer_city', $testimonial['customer_city'] ?? '') ?>">
                                </div>
                            </div>
                            <div class="col-md-6">
                                <div class="mb-3">
                        ...
                        <div class="mb-3">
                            ...
                            <textarea class="form-control" id="testimonial_text" name="testimonial_text" 
                                      rows="5" required><?= old('testimonial_text', $testimonial['testimonial_text'] ?? '') ?></textarea>
                        </div>
                    </div>
                </div>
                            ...
                            <div class="col-md-6">
                                <div class="mb-3">
                                    ...
                                    <input type="text" class="form-control" id="package_name" name="package_name" 
                                           value="<?= old('package_name', $testimonial['package_name'] ?? '') ?>" placeholder="e.g., Goa Beach Paradise - 4 Days">
                                </div>
                            </div>
                            <div class="col-md-6">
                                <div class="mb-3">
                                    ...
                                    <input type="date" class="form-control" id="travel_date" name="travel_date" 
                                           value="<?= old('travel_date', $testimonial['travel_date'] ?? '') ?>">
                                </div>
                            </div>
                        </div>
                    </div>
            ...
            <div class="col-lg-4">
                    ...
                    <div class="card-body">
                        <div class="mb-3">
                            ...
                            <select class="form-select" id="status" name="status">
                                ...
                                <option value="approved" <?= old('status', $testimonial['status'] ?? 'pending') == 'approved' ? 'selected' : '' ?>>Approved</option>
                                <option value="rejected" <?= old('status', $testimonial['status'] ?? 'pending') == 'rejected' ? 'selected' : '' ?>>Rejected</option>
                            </select>
                        </div>

                        <div class="form-check mb-3">
                            <input type="checkbox" class="form-check-input" id="is_featured" name="is_featured" value="1"
                                   <?= old('is_featured', $testimonial['is_featured'] ?? 0) ? 'checked' : '' ?>>
                        ...
                        <div class="mb-3">
                            <small class="text-muted">
                                <strong>Created:</strong> <?= date('M j, Y g:i A', strtotime($testimonial['created_at'] ?? 'now')) ?><br>
                                <strong>Updated:</strong> <?= date('M j, Y g:i A', strtotime($testimonial['updated_at'] ?? 'now')) ?>
                            </small>
                        </div>
                    </div>
                </div>
                ...
                <div class="card">
                    ...
                    <div class="card-body">
                        <?php if (isset($testimonial['customer_image']) && $testimonial['customer_image']): ?>
                    ...
                    <div class="card-body">
                        <div class="d-grid gap-2">
                            <button type="submit" class="btn btn-primary">
                                <i data-lucide="save" class="me-1"></i> Update Testimonial
                            </button>
...
document.addEventListener('DOMContentLoaded', function() {
    ...
    removeCurrent?.addEventListener('click', function() {
        if (confirm('Remove current customer photo?')) {
            currentImage.style.display = 'none';
